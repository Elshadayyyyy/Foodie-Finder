  ...
  useEffect(() => {
    const fetchFavoriteMeals = async () => {
      ...
      try {
        ...
        const validMeals: Meal[] = mealsResults.filter((meal): meal is Meal => meal !== null);
  ...
  if (loading) {
    return (
      <div className="space-y-8 py-4">
        <h1 className="text-4xl font-bold text-center text-primary mb-8">Your Favorite Meals</h1>
